  ...
  setup(__props, { expose, emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return unref(model) ? (openBlock(), createBlock(_component_el_form, mergeProps({
            ...
            return openBlock(), createElementBlock(Fragment, { key: index2 }, [
              !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  ...
                  }), null, 16, ["placeholder", "modelValue", "onUpdate:modelValue"])) : createCommentVNode("v-if", true),
                  item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({ key: 1 }, item.uploadAttrs, {
                    ...
                    _: 2
                  }, 1040, ["on-preview", "on-remove", "on-success", "on-error", "on-progress", "on-change", "before-upload", "before-remove", "http-request", "on-exceed"])) : createCommentVNode("v-if", true),
                  item.type === "editor" ? (openBlock(), createElementBlock("div", _hoisted_1)) : createCommentVNode("v-if", true)
                ]),
                _: 2
              }, 1032, ["prop", "label"])) : createCommentVNode("v-if", true),
              item.children && item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                key: 1,
                prop: item.prop,
                label: item.label
        ...
        _: 3
      }, 16, ["model", "rules"])) : createCommentVNode("v-if", true);
    };
  }
});
var index = {
