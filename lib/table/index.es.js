  ...
  setup(__props, { emit: emits }) {
    ...
    let rowClick = (row, column) => {
      if (column.label === actionOption.value.label) {
        if (props.isEditRow && clFoneEditRowIndex.value === props.editRowIndex) {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(tableOption), (item, index2) => {
              return openBlock(), createElementBlock(Fragment, { key: index2 }, [
                item.prop && !item.action ? (openBlock(), createBlock(_component_el_table_column, {
                  ...
                  _: 2
                }, 1032, ["label", "prop", "width", "align"])) : createCommentVNode("v-if", true)
              ], 64);
            }), 128)),
...
var table = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-495cf57e"]]);
var index = {
  install(app) {
